...
export const MANSION_FURNITURE_ANCHORS: FurnitureAnchorDef[] = [
  // --- BEDCHAMBER ---
  {
    ...
    role: 'bed',
    maxScale: 0.50,
    clearanceBox: { x: 125, y: 190, width: 110, height: 90 },
  },
  {
    ...
    role: 'wardrobe',
    maxScale: 0.50,
    clearanceBox: { x: 145, y: 70, width: 70, height: 60 },
  },
  {
    ...
    role: 'vanity',
    maxScale: 0.50,
    clearanceBox: { x: 295, y: 70, width: 70, height: 60 },
  },
  {
    ...
    role: 'armchair',
    maxScale: 0.45,
    clearanceBox: { x: 65, y: 180, width: 50, height: 50 },
  },
  {
    ...
    role: 'nightstand',
    maxScale: 0.42,
    clearanceBox: { x: 100, y: 220, width: 40, height: 45 },
  },
  ...
  {
    id: 'anchor_lounge_sofa_west',
    zone: 'lounge',
    name: 'Lounge West Sofa facing Table',
    anchor: { x: 935, y: 720 },
    role: 'sofa',
    maxScale: 0.45,
    clearanceBox: { x: 885, y: 670, width: 100, height: 60 },
  },
  {
    id: 'anchor_lounge_sofa_east',
    zone: 'lounge',
    name: 'Lounge Mirrored East Sofa facing Table',
    anchor: { x: 1145, y: 720 },
    role: 'sofa',
    maxScale: 0.45,
    clearanceBox: { x: 1095, y: 670, width: 100, height: 60 },
  },
  {
    id: 'anchor_lounge_coffee_table',
    zone: 'lounge',
    name: 'Lounge Centered Coffee Table',
    anchor: { x: 1040, y: 720 },
    role: 'coffee_table',
    maxScale: 0.50,
    clearanceBox: { x: 990, y: 680, width: 100, height: 50 },
  },
  {
    id: 'anchor_lounge_armchair',
    zone: 'lounge',
    name: 'Lounge Armchair facing Table',
    anchor: { x: 1040, y: 795 },
    role: 'armchair',
    maxScale: 0.44,
    clearanceBox: { x: 1005, y: 755, width: 70, height: 55 },
  },
  {
  ...
  },
  {
    ...
    role: 'tv',
    maxScale: 0.44,
    clearanceBox: { x: 1140, y: 535, width: 80, height: 55 },
  },
];
